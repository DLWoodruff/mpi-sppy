...
# special driver for scalability experiments with multiple upper bound spokes
# It 
...
def _parse_args():
    ...
    parser.add_argument("--crops-mult",
                        ...
                        type=int,
                        default=1)                
    parser.add_argument("--extra-bound-cnt",
                        help="Add this many xhatlooperbounder spokes (0)",
                        dest="extra_bound_cnt",
                        type=int,
                        default=0)
...
def main():
    ...
    for i in range(args.extra_bound_cnt):
        list_of_spoke_dict.append(xhatshuffle_spoke)
